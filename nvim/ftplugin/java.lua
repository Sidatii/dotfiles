...
--       home = "/usr/lib/jvm/jdk-23-oracle/bin/java",
--       eclipse = {
...
--     local ok, cmp_nvim_lsp = pcall(require, "cmp-nvim-lsp")
--     if ok then
...
--
-- -- Needed for debugging
-- -- DAP configuration for Java (auto debug launch)
-- config["on_attach"] = function(client, bufnr)
--   -- require("plugins.on_attach").on_attach(client, bufnr)
--   jdtls.setup_dap({
--     hotcodereplace = "auto",
--   })
